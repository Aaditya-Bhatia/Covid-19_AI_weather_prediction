...
newCases = pd.read_csv('new_cases.csv')  # this has countries as cols
newDeaths = pd.read_csv('new_deaths.csv') # this has countries as cols
totalCases = pd.read_csv('total_cases.csv') # this has countries as cols
totalDeaths = pd.read_csv('total_deaths.csv') # this has countries as cols
